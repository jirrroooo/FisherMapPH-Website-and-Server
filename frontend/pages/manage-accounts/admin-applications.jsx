        ...
        <div className="container mt-4 text-center">
          ...
          <div className="card mt-3 p-2">
            ...
            <div className="row student-data">
              ...
              <div className="col-2">
                <p>02/07/23, 8:00 AM</p>
              </div>
              <div className="col-2">
                <button className="btn btn-light px-4 rounded-5 fw-semibold text-black">View</button>
              </div>
              <div className="col-3">
                <div className="row">
                  <div className="col">
                    <button className="btn btn-success px-3 rounded-5 fw-semibold text-white">Accept</button>
                  </div>
                  <div className="col">
